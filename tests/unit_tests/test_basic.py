...
def test_package_imports() -> None:
    ...
    assert pydockerutils.__name__ == "pydockerutils"


def test_all_modules_import() -> None:
    """Every module in the package imports without errors."""
    for info in pkgutil.walk_packages(pydockerutils.__path__, prefix="pydockerutils.", onerror=_raise_on_package_error):
